...
class StandardDataLoader:
    ...
    def load_dataframe(self, filename: str, test: bool = False, n_rows: int = 1_000_000) -> pd.DataFrame:
    ...
    def load_chunks(self, filename: str, chunk_size: int = 500_000, test: bool = False) -> Iterator[pd.DataFrame]:
        file_path = join(self.dump_path, filename)
...
def get_data_loader(env: str, datastore: Optional[str], dump_path: Optional[str], logger) -> DataLoaderProtocol:
