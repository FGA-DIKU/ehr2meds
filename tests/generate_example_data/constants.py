...
MED_ACTIONS = [
    "Administreret",
    "MDA-standby",
    "Frigiv fra MDA-standby",
    "Forfalden",
    "Afventer",
    "Pause",
    "Ophævet pause",
    "Automatisk sat på standby",
    "Ny pose",
    "Ikke administreret",
    "Selvadministration",
    "Stoppet",
    ...
    "Sat på pause",
    "Ikke taget",
    "Annulleret indtastning",
    "Genstartet",
    "Selvmedicinering",
    "Anæstesi, volumen justering",
    "Orlov startet",
    "Orlov slutter",
]
...
PROCEDURE_NAMES = [
    "VID. UDR/UDR.PLAN UDARB/PT ØNSK OM UDR P SENERE TIDSP E TILB",
    "KLINISK BESLUTNING: ENDELIGT UDREDT BEHANDLING I SYGEHUSREGI",
    "UL-VEJLEDT MÅLING AF ØJENAKSER (A-SKANNING)",
    "JOURNALOPTAGELSE",
    ...
    "AMBULANT BESØG",
    "TELEFONKONSULTATION",
    "PATIENT SAT I KARANTÆNE",
    "SKADESTUEBESØG",
    "MEDICINGIVNING I ØJE",
    ...
    "FØRSTEGANGSBESØG",
    "ORTOPAN-TOMOGRAFI AF KÆBER",
    "KLINISK UNDERSØGELSE",
    "INDLÆGGELSESSAMTALE",
    "SAMTALE MED PATIENT OM OPERATION OG BEHANDLINGSFORLØB",
    "TILSYN VED SPECIALLÆGE",
    "OTOSKOPI",
    "OTOMIKROSKOPI",
    "ANLÆGGELSE AF TUBE I LUFTVEJE",
    "KIRURGISK FJERNELSE AF TAND",
]

LAB_TESTS = [
    "HÆMOGLOBIN (ARB.STOFK.);F",
    "HISTOLOGI",
    "NATRIUM;P",
    "TRIGLYCERID;P",
    "HÆMOGLOBIN A1C (IFCC);HB(B)",
    "GLUKOSE, MIDDEL (FRA HBA1C);P",
    "KALIUM;P",
    ...
    "KREATININ;U",
    "KOLESTEROL LDL (BEREGNET);P",
    "C-REAKTIVT PROTEIN(CRP)(POC);P",
    "ELEKTROKARDIOGRAFI (EKG12);PT",
    "ERYTROCYTTER;B",
    "BASISK FOSFATASE;P",
    "TROMBOCYTTER;B",
    ...
    "ANION GAP (INKL. K+)(POC);P",
    "C-REAKTIVT PROTEIN [CRP];P",
    "THYROTROPIN [TSH] (LOKAL);P",
    "KALIUM(POC);P",
    "ECV-BASE EXCESS;(POC)",
    "LYMFOCYTTER;B",
    "LEUKOCYTTER;B",
    ...
    "BILIRUBINER;P",
    "CARBONMONOXIDHÆMOGLOBIN(POC);HB(B)",
    "HÆMOGLOBIN(POC);B",
    "CALCIUM-ION FRIT (PH=7,4)(POC);P",
    ...
    "KLORID(POC);P",
    "GLUKOSE(POC);P",
    "ACETOACETAT(SEMIKVANT)(POC);U",
    "METHÆMOGLOBIN(POC);HB(B)",
    "METAMYELO.+MYELO.+PROMYELOCYTTER;B",
    "URINUNDERSØGELSE STIX GRUPPE (POC);U",
    "P-HYDROGENCARBONAT (STANDARD);(POC)",
    "P(AB)-PH;(37 °C POC)",
    "GÆRSVAMPE (DYRKNING)",
    "P(AB)-PCO2;(37 °C POC)",
    "SYREBASESTATUS GRUPPE(POC);PT(AB)",
    "ERYTROCYTTER (SEMIKVANT.)(POC);U",
    "BLODDYRKNING(BACTERIUM+FUNGUS);B",
    "PRØVEMATERIALE:",
    "GLUKOSE(SEMIKVANT)(POC);U",
    "UDFØRT AF:",
    "PH(POC);U",
...
LAB_RESULTS = [
    ...
    "0.5",
    "26.4",
    "Ingen vækst efter endt dyrkning",
    "7.46",
    "4.9",
    "<10",
    "Ingen vækst",
    ...
    "-4",
    "400",
    "Sinusbradykardi  I øvrigt normalt EKG  ",
    "118",
    "422",
    "27",
    "Taget",
    ...
    "<2.0",
    "Påvist",
    "Ingen vækst af patogene bakterier",
    "Ingen vækst af gærsvampe",
    "33",
    "39",
    "4.67",
    "1.97",
...
FORL_TYPE = [
    ...
    "akutmodtageenhed",
    "skadestue",
    "fysioterapi- og ergoterapiklinik",
